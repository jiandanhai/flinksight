...
public interface TenantConfigRepository extends JpaRepository<TenantConfig, Long> {
     ...
     * 获取某租户全部有效配置
     */
    Page<TenantConfig> findByTenantIdAndIsDeleted(Long tenantId, Integer isDeleted, Pageable pageable);

    /**
     * 根据配置key查找所有未删除的配置
     */
    Page<TenantConfig> findByConfigKeyAndIsDeleted(String configKey, Integer isDeleted, Pageable pageable);
     ...
     */
    Page<TenantConfig> findAllByTenantIdAndIsDeleted(Long tenantId, Integer isDeleted, Pageable pageable);
}
